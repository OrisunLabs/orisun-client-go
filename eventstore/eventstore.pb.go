...
const file_protos_eventstore_proto_rawDesc = "" +
	"\n" +
	"\x17protos/eventstore.proto\x12\x06orisun\x1a\x1fgoogle/protobuf/timestamp.proto\"^\n" +
	"\bPosition\x12'\n" +
...
var file_protos_eventstore_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
